...
for qs = [0.25 0.5 0.75]
    for kappas = [0.25 0.5 0.75]
        ...
        set(gca,'FontSize',16);
        % pause(1);
        % savefig(strcat('Scenario_1_Constant_Constraints_optimization_type2_q', num2str(qs), '_ka', num2str(kappas), '.fig'));
        % saveas(gcf, strcat('Scenario_1_Constant_Constraints_optimization_type2_q', num2str(qs), '_ka', num2str(kappas), '.jpg')); % Save as JPG
        hold off
...
for i=2:60
    ...
    input_vector = [I(i)/N(i) (I(i) - I(i-1))/N(i) upperbound_vacc(i) upperbound_sicial(i)];
