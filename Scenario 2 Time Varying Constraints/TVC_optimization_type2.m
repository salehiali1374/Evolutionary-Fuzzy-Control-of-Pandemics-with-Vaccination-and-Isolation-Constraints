...
%     options.UseParallel = 1;
    ...
    rand_sicial = 0.1;
    rand_vacc = 0.0;
    upperbound_sicial= [rand_sicial*ones(1,10) linspace(rand_sicial,1,40) 1*ones(1,10)];
    upperbound_vacc= [rand_vacc*ones(1,10) linspace(rand_vacc,1,40) 1*ones(1,10)];
...
cost = sum(abs(I));% + sum(abs(y-I)<0.0001); % cost function
